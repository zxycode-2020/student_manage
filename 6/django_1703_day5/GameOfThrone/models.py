...
class UserProfile(models.Model):
    ...
    class Meta:
        verbose_name = verbose_name_plural = '用户详细信息'
...
class Student(models.Model):
    ...
    score = models.DecimalField(verbose_name='学生成绩',max_digits=5,decimal_places=2,null=True,blank=True,default=99.99) # 最大位数和小数位多少
...
class Group(models.Model):
    name = models.CharField(verbose_name='社团',max_length=30)

    class Meta:
        verbose_name = verbose_name_plural = '社团表'
